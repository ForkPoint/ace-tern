...
define((require, exports, module) => {
    ...
    const compliantExecNpcg = real.exec.call(/()??/, '')[1] === undefined; // check `exec` handling of nonparticipating capturing groups
    const compliantLastIndexIncrement = (function () {
        const x = /^/g;
        real.test.call(x, '');
        return !x.lastIndex;
    }());
    ...
    RegExp.prototype.exec = function (str) {
        const match = real.exec.apply(this, arguments);
        let name; let
            r2;
    ...
    if (!compliantLastIndexIncrement) {
        ...
        RegExp.prototype.test = function (str) {
            ...
            const match = real.exec.call(this, str);
            // Fix browsers that increment `lastIndex` after zero-length matches
